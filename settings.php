    ...
    <div class="whole">
        ...
        <div class="page">
            ...
            <div class="settings-container">
                ...
                <div class="settings-section">
                    <h2><i class="bi bi-person-vcard"></i> Verify Personal Information</h2>
                    ...
                    <div class="setting-item">
                        ...
                        <span class="setting-value"><?= htmlspecialchars($_SESSION['firstName'] ?? '') ?>
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-action">
                            <button class="btn-edit" onclick="openVerify()">Verify</button>
                        </div>
                    </div>
                </div>
                ...
                <div id="verifyModal" class="modal">
                    <div class="modal-content" style="max-width: 500px;">
                        <h2>Verification</h2>
                        <div class="scrollable" style="text-align: start;">
                            Select you ID to verify your information
                            <input type="file">
                        </div>
                        <button class="next_prev" onclick="">Verify</button>
                        <button class="close-btn" onclick="closeVerify()">Close</button>
                    </div>
                </div>
